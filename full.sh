...
version() {
  cp -f $COMMON/Calculator/Calculator.tar.xz $BUILDDIR/$TYPE/$ARCH/$RELEASEDIR/$SYS
  ...
  cp -f $COMMON/Chrome/Chrome.tar.xz $BUILDDIR/$TYPE/$ARCH/$RELEASEDIR/$SYS
  cp -f $COMMON/Chrome/Library.tar.xz $BUILDDIR/$TYPE/$ARCH/$RELEASEDIR/$SYS
  cp -f $LEGACY/Gboard/Gboard.tar.xz $BUILDDIR/$TYPE/$ARCH/$RELEASEDIR/$SYS
  cp -f $LEGACY/Gmail/Gmail.tar.xz $BUILDDIR/$TYPE/$ARCH/$RELEASEDIR/$SYS
  cp -f $LEGACY/Maps/Maps.tar.xz $BUILDDIR/$TYPE/$ARCH/$RELEASEDIR/$SYS
  cp -f $LEGACY/Maps/GLH.tar.xz $BUILDDIR/$TYPE/$ARCH/$RELEASEDIR/$SYS
  ...
  if [ "$API" -ge "28" ]; then
    cp -f $COMMON/Wellbeing/Wellbeing.tar.xz $BUILDDIR/$TYPE/$ARCH/$RELEASEDIR/$CORE
  fi
}
